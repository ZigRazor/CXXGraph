...
namespace CXXGRAPH
{
    namespace PARTITIONING
    {
        ...
        {
        private:
            std::deque<const Edge<T> *> dataset = {};
        ...
        public:
            Partitioner(const std::deque<const Edge<T> *> &dataset, Globals &G);
        ...
        template <typename T>
        Partitioner<T>::Partitioner(const std::deque<const Edge<T> *> &dataset, Globals &G) : GLOBALS(G)
        {
            //this->GLOBALS = G;
