...
TEST(KruskalTest, test_1)
{
    ...
    CXXGRAPH::UndirectedWeightedEdge<int> edge10(10, node2, node3, 7);
    ...
    CXXGRAPH::MstResult res = graph.kruskal();
    ...
    CXXGRAPH::MstResult res_ts = graph_ts.kruskal();
