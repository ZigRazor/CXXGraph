...
TEST(RWOutputTest, test_22)
{
    ...
    CXXGRAPH::Graph<int> readGraph;
    auto readResult = readGraph.readFromFile(CXXGRAPH::Graph<int>::InputOutputFormat::STANDARD_CSV, ".", "test_22", true, true, true);
...
TEST(RWOutputTest, test_25)
{
    ...
    CXXGRAPH::Graph<int> readGraph;
    auto readResult = readGraph.readFromFile(CXXGRAPH::Graph<int>::InputOutputFormat::STANDARD_TSV, ".", "test_25", true, true, true);
    ASSERT_EQ(readResult, 0);
    auto readNode = readGraph.getNodeSet();
    auto readEdge = readGraph.getEdgeSet();
    ASSERT_EQ(readEdge.size(), 3);
